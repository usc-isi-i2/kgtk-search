...
class App extends React.Component {
    ...
    submit_es_query() {
        ...
        if (!query) {
            ...
            return fetch(`/api/${query}?extra_info=true&language=${language.value}&type=${type.value}`, {
                method: 'GET',
                headers: {
            ...
            <ThemeProvider theme={theme}>
                <Container maxWidth="xl">
                    ...
                    <form className={classes.form} noValidate onSubmit={this.submit.bind(this)}>
                        <Dropdown options={languageOptions} onChange={this.OnLanguageChange.bind(this)}
                                  value={defaultLanguageOption}
                                  placeholder="Select Language" wi/>
                        <Dropdown options={queryTypeOptions} onChange={this.OnTypeChange.bind(this)}
